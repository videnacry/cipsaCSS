        ...
        <div className='position-relative bg-img-repeating-gradient-135-bccccc-f3fdff-bccccc-00dot4'>
            <div className='w-94dot776-percent ml-3dot5-percent pt-2dot6-percent border-box overflow-y-auto'>
                <div className='filter-grayscale-0dot2 border-0dot5-vw-cccbcfcf border-right-03-vw  bg-clip-content-box bg-a4adbf'>
                    ...
                    <div className='flex-row justify-content-space-between bg-white'>
                        <article className='w-68-percent'>
                            ...
                            <ul className='flex-row p-00 list-style-type-none font-family-monospace font-size-1dot6-vw color-3e2b55 font-weight-600 mt-00'>
                        ...
                        <aside className='w-28dot6-percent border-light-gray border-02 border-right-00 border-top-00'>
                            ...
                            <section className='font-size-1dot3-vw'>
                                <h3 className='mt-00 mb-5-percent bg-737ba0 font-weight-500 color-dddddd font-family-monospace font-size-1dot6-vw text-shadow-whitesmoke'>Registro</h3>
                            ...
                            <section className='font-size-1dot3-vw'>
                                <h3 className='mt-00 mb-5-percent bg-737ba0 font-weight-500 color-dddddd font-family-monospace font-size-1dot6-vw text-shadow-whitesmoke'>Otras informaciones</h3>
                    ...
                    <footer className='bg-white pb-01-percent'>
                        <p className='text-align-end text-shadow-black mr-1dot5-percent color-bebebe font-size-1dot4-vw m-00'>
