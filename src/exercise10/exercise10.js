        ...
        <div className='w-94dot776-percent ml-3dot5-percent pt-2dot6-percent'>
            ...
            <div className='flex-row justify-content-space-between'>
                <article className='w-68-percent'>
                    ...
                    <p className='line-height-18 my-10 color-5f5d67 font-family-system-ui text-shadow-b9b9b9-20-grey-2 font-size-1dot5-vw'>
                    ...
                    <ul className='flex-row p-0 list-style-type-none m-12 font-family-monospace font-size-16 color-3e2b55 font-weight-600 mt-00'>
                        <li className='font-size-1dot6-vw'><a className='font-family-monospace color-2f1f43 font-weight-600 text-shadow-bf3fbf-14-black-1' id='volver' href='./#volver'>Volver</a></li>
                        &nbsp;|&nbsp;
                        <li className='font-size-1dot6-vw'><a className='font-family-monospace color-2f1f43 font-weight-600 text-shadow-bf3fbf-14-black-1' id='portada' href='./#portada'>Portada</a></li>
                        &nbsp;|&nbsp;
                        <li className='font-size-1dot6-vw'><a className='font-family-monospace color-2f1f43 font-weight-600 text-shadow-bf3fbf-14-black-1' id='mapa-sitio' href='./#mapa-sitio'>Mapa del sitio</a></li>
                    </ul>
                </article>
                <aside className='w-28dot6-percent border-light-gray border-02 border-right-00 border-top-00'>
                    <section className=''>
                        <h3 className='mt-00 mb-10 bg-737ba0 font-weight-500 color-dddddd font-family-monospace font-size-1dot6-vw text-shadow-whitesmoke text-shadow-left-01'>Buscar</h3>
                        ...
                        <div className='ml-6dot5-percent color-5f5d67 font-size-1dot4-vw'>
                    ...
                    <section className='font-size-1dot4-vw'>
                        <h3 className='mt-00 bg-737ba0 font-weight-500 color-dddddd font-family-monospace font-size-1dot6-vw text-shadow-whitesmoke text-shadow-left-01'>Registro</h3>
                    ...
                    <section className='font-size-1dot4-vw'>
                        <h3 className='mt-00 bg-737ba0 font-weight-500 color-dddddd font-family-monospace font-size-1dot6-vw text-shadow-whitesmoke text-shadow-left-01'>Otras informaciones</h3>
